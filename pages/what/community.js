...
export default () => (
  <Layout
    path="what/community"
    title="Community"
    description="A club restricted to code enthusiasts."
  >
    <article className="card card-1">
      <Trans>
        ...
        <p>
          The name &ldquo;Inglorious Coderz&rdquo; also stands for a community
          of code enthusiasts who used to meet every Sunday to experiment with
          the latest technologies, apply them to interesting projects and share
          know-how, internally or to the world, contributing to open source
          projects or holding high-tech talks in dedicated events.
        </p>

        <p>
          Nowadays we hardly meet live because of everyone&apos;s commitments
          and geographical dislocation, but there is still a thriving{' '}
