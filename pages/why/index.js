...
export default () => {
  ...
  useEffect(() => {
    interval = setInterval(() => setDate(new Date()), ONE_SECOND)
  ...
  return (
    ...
    >
      <article className="card card-1">
        ...
        <p>
          It is UNIX time <code>{Math.round(date.getTime() / 1000)}</code>, the
          Age of Information. Everything is connected, everything sends and
          receives data.
        </p>
        <p>
          Humans are overwhelmed by superficial information and are losing any
          deep thought, any interest in knowledge. Ensnared by consumerism, they
