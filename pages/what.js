        ...
        <div className="row">
          ...
          <div className="col-md-8">
            ...
            <p>
              ...
              rely on us to provide the best training experience.
            </p>
            <p>
              Every lesson is a show: students manage to grasp the most
              difficult concepts explained in a super-easy and fun way. During
              our courses we build a complete project step-by-step from the
              ground up, and every step is backed by strong theoretical
              concepts.
            </p>
          </div>
        </div>
